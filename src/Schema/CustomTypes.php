...
class CustomTypes
{
    ...
    private static ?EnumType $queryOperator = null;

    private static ?EnumType $queryTypes = null;

    private static ?EnumType $rangeOperator = null;
    ...
    private static ?ObjectType $deliveryDate = null;

    private static ?ObjectType $deliveryInformation = null;

    private static ?ObjectType $calculatedTax = null;

    private static ?ObjectType $calculatedPrice = null;

    private static ?ObjectType $lineItem = null;

    private static ?ObjectType $cartPrice = null;

    private static ?ObjectType $cart = null;

    private static ?ObjectType $transaction = null;

    private static ?ObjectType $shippingLocation = null;

    private static ?ObjectType $deliveryPosition = null;
